...
class InterviewPreliminaryScheduled extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('👔 Entrevista preliminar programada')
            ->greeting('Hola ' . $notifiable->name)
            ->line('Has sido invitado(a) a una **entrevista preliminar**.')
            ->line("📅 **Fecha:** {$fecha}\n💬 **Medio:** {$medio}")
